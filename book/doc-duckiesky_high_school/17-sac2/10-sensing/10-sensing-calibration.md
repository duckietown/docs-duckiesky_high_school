...
4. Finally, explain (or have them derive) the actual mathematical relationship between voltage and distance. Highlight that the data takes on the shape of 1/x, and then show a graph of voltage vs 1/distance.
